...
<body>
  ...
  <main class="main">
    <section class="main__block">
      <h2 class="sell__block__head">編集画面</h2>
            ...
            <div id="image-box-1">
              <div class="item-num-0" id="image-box__container">
                <div class="input-area">
                  ...
                  @endif
                  <input id="img-file" type="file" name="image" value="{{ $post->image }}">
            ...
            <div class="sell__block__form__name">
              <div class="form-group__name select1">
                ...
                <div>
                  ...
                  @endif
                  <input class="form__group__name title" type="text" name="name" placeholder="商品名" value="{{ $post->name }}">
                </div>
                ...
                <div>
                  ...
                  @endif
                  <input class="form__group__name title" type="text" name="brand" placeholder="ブランド" value="{{ $post->brand }}">
                </div>
              </div>
